    ...
    public class WeatherApi
    {
        ...
        (double lat, double lon) GetCoords(string cityName) 
        {
            try
            {
                ...
                CurrentWeatherApiResponse deserializedResponse = JsonSerializer.Deserialize<CurrentWeatherApiResponse>(sResponse);

                return (deserializedResponse.coord.lat, deserializedResponse.coord.lon);
            }
